...
prob_alarm0 = infer.query(variables=['Alarm', 'JohnCalls', 'MaryCalls'], evidence={'Burglary': 0, 'Earthquake': 0}, show_progress=False)
print(
    "Exercício 1: Qual a probabilidade de não ocorrer um roubo,\nnem terremoto, mas tocar o alarme, e John e Mary liguarem?")
print("")
